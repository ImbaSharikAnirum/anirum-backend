...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    courseType: Schema.Attribute.Enumeration<
      ['club', 'course', 'intensive', 'individual']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    direction: Schema.Attribute.Enumeration<
      ['sketching', 'drawing2d', 'animation', 'modeling3d']
    > &
      Schema.Attribute.Required;
    endAge: Schema.Attribute.Integer &
    ...
    startAge: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 99;
          min: 3;
    ...
    status: Schema.Attribute.Enumeration<['pending_approval', 'approved']> &
    ...
    timezone: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Europe/Moscow'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGuideGuide extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0413\u0430\u0439\u0434\u044B \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u0435\u0439 \u0441 \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F\u043C\u0438 \u0438 \u0441\u0441\u044B\u043B\u043A\u0430\u043C\u0438';
    displayName: 'Guide';
    pluralName: 'guides';
    singularName: 'guide';
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    pinterestAccessToken: Schema.Attribute.Text;
    pinterestRefreshToken: Schema.Attribute.Text;
